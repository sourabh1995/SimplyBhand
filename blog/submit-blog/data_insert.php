...
include_once 'ckeditor/ckeditor.php';
 ...
 $chkNew .= $chkNew1 . ","; 
	...
	$file = fopen("upload/".$_POST['name'] ." ".$title. ".doc","w+");
        
        fwrite($file, $content);
        fclose($file);
        $file_name = "upload/".$_POST['name'] . ".html";
        
    # code...
    $query = "INSERT INTO submit_work(title,name,phone,email,content,category,agreed) VALUES ('$title','$name','$phone','$email','$content','$chkNew','$file_name')";
...
<br><br>
    ...
    <div class="container">
     ...
     echo ' <center><div class="notify successbox">
        ...
        <a href="http://blog.simplybhand.com/submit-blog/"><button class="btn-change7">Write More</button></a>
      ...
      echo '<center><div class="notify errorbox">
        ...
        if($msg == 3){
          echo '<p>Sorry !! Failed to load image . Try Uploading another image.</p>
        <p class= "pull-right"> Team Simply Bhand </p>
        <a href="http://blog.simplybhand.com/submit-blog/"><button class="btn-change7">Write Another Blog</button></a>
      </div></center>';
    }
    if($msg == 2){
