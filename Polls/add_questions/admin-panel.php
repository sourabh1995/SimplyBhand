...
$cat1 = "SELECT * FROM polls_question WHERE Category=1";
$cat2 = "SELECT * FROM polls_question WHERE Category=2";
$cat3 = "SELECT * FROM polls_question WHERE Category=3";
$cat4 = "SELECT * FROM polls_question WHERE Category=4";
$cat5 = "SELECT * FROM polls_question WHERE Category=5";
$cat6 = "SELECT * FROM polls_question WHERE Category=6";
$cat7 = "SELECT * FROM polls_question WHERE Category=7";
$cat8 = "SELECT * FROM polls_question WHERE Category=8";
$cat9 = "SELECT * FROM polls_question WHERE Category=9";
?>
<!DOCTYPE HTML>
<html>
	<head>
		...
		<div class="container-fluid">
			...
			<div class="section-title">
				...
				<div class="push-right container">
					<p class="demo-text">Category | Total Polls </p>
				...
				<table class="table">
					<tr><td>ID</td><td>Category</td><td>Question</td><td>Option 1</td><td>Option 2</td><td>Option 3</td><td>Option 4</td><td>Option 5</td><td>Option 6</td><td>By</td></tr>
					<?php
					if($result->num_rows > 0)
					{
					while($row = $result->fetch_assoc())
					{
						echo "<tr><td>".$row['id']."</td><td> ".$row['Category']."</td><td> ".$row['Question']."</td><td>".$row['Option1']."</td><td> ".$row['Option2']."</td><td>".$row['Option3']."</td><td> ".$row['Option4']."</td><td>".$row['Option5']."</td><td>".$row['Option6']."</td><td>".$row['madeby']."</td></tr>";
